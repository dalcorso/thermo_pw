#if defined(__CUDA)
ATTRIBUTES(DEVICE) subroutine c1fm1f ( n, inc, c, lenc, ch, wa, fnf, fac )
#else
subroutine c1fm1f ( n, inc, c, lenc, ch, wa, fnf, fac )
#endif
...
!
  ...
  implicit none
#if defined(__CUDA)
#include<c1f2kf_interf.f90>
#include<c1f3kf_interf.f90>
#include<c1f4kf_interf.f90>
#include<c1f5kf_interf.f90>
#include<c1fgkf_interf.f90>
#endif
