...
(in this section we switch between standard and Voigt notations.
It should be clear from the number of indexes which notation we are using):
\begin{eqnarray}
B_{4,4} &=& {1 \over V}{\partial^2 U \over \partial \epsilon^2_{4}}\Bigg|_{\epsilon=0} - {1\over 2} p, \\
B_{5,5} &=& {1 \over V}{\partial^2 U \over \partial \epsilon^2_{5} 
}\Bigg|_{\epsilon=0} - {1\over 2} p, \\
B_{6,6} &=& {1 \over V}{\partial^2 U \over \partial \epsilon^2_{6} 
}\Bigg|_{\epsilon=0} - {1\over 2} p, \\
B_{1,2} &=& {1 \over V}{\partial^2 U \over \partial \epsilon_{1} 
\partial \epsilon_{2}}\Bigg|_{\epsilon=0} + p, \\
B_{1,3} &=& {1 \over V}{\partial^2 U \over \partial \epsilon_{1} 
\partial \epsilon_{3}}\Bigg|_{\epsilon=0} + p, \\
B_{2,3} &=& {1 \over V}{\partial^2 U \over \partial \epsilon_{2} 
\partial \epsilon_{3}}\Bigg|_{\epsilon=0} + p, 
\end{eqnarray}
while for all the other components $B_{i,j}=
