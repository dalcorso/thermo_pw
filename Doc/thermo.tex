...
\begin{equation}
C_{ij,kl} = {1\over V} { \partial^2 U \over \partial \epsilon_{ij} \partial 
...
\end{equation}
It is also possible to recalculate the $B_{ij,kl}$ from $C_{ij,kl}$:
\begin{equation}
B_{ij,kl} = C_{ij,kl} -{1\over 2} \left (2 \sigma^{(0)}_{ij} \delta_{kl}
...
\begin{equation}
B_{ij,kl} = C_{ij,kl} +p \left (\delta_{ij} \delta_{kl}
