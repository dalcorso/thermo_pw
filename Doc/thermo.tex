...
c&=&c_t.
\end{eqnarray}
The reference system of the orthorombic cell is rotated with respect to
...
Applying $\epsilon_G$ to an simple orthorombic cell transforms it into a 
...
\end{eqnarray}
The reference system of the simple monoclinic cell is rotated with respect to
the reference system of the orthorombic cell. 
The change of coordinates can be written as above with the rotation matrix 
\begin{equation}
...
the reference system of the simple (base-centered) orthorombic cell. 
The change of coordinates can be written as above with the rotation matrix 
\begin{equation}
...
with respect to the reference system of the face-centered orthorombic cell. 
The change of coordinates can be written as above with the rotation matrix 
$R^E$ and ${\rm tg}\phi=-\epsilon_{1,2}$.
...
\end{eqnarray}
The reference system of the base-centered monoclinic cell is rotated 
with respect to the reference system of the body-centered orthorombic cell. 
The change of coordinates can be written as above with the rotation matrix 
$R^E$ and
\begin{equation}
...
\end{eqnarray}
which is valid for the simple orthorombic lattice as well as for the
base-centered, the face-centered, and the body-centered orthorombic lattices.
