...
In general, a strain changes both the size of the
and the shape of the unit cell possibly changing the Bravais lattice. 
In this section we consider some strains of interest for our applications and
...
\right),
\end{equation}
with the possibility to apply different a sign in one direction
\begin{equation}
...
$\epsilon_6=2 \epsilon_{1,2}$ and a generic strain is:
\begin{equation}
...
\end{eqnarray}
while the body-centered cubic cell is transformed by 
