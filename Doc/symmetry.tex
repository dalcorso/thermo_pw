...
This routine generates a mesh of ${\bf k}$ points given $N_1$ (called
...
point is in the original list, it is removed from the list and the 
weight of the point ${\bf k}_i$ is increased of 1. In output 
...
\texttt{kpoint\_grid}.
Given a subgroup $H$ with $k$ (\texttt{nsym}) elements it gives all
the ${\bf k}$ points and their weights reduced with the group $H$.

The algorithm is the following: given ${\bf k}_i$ we rotate it with 
all elements of $G$ and obtain the star of ${\bf k}_i$. Given ${\bf k}_i$
rotating with all elements of $H$ we obtain the star of ${\bf k}_i$
for $H$. Of this star we have to save only the point ${\bf k}_i$. 
