...
the weights. 
Usually the same labels used to indicate the coordinates of the points
are written also in the dispersion plot, but it is also possible
to override these labels, adding a letter after the weights as for 
...
with 20 points, the third from $W$ to a point of coordinates $(1.0, 1.0, 0.0)$ 
