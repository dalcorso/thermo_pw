...
the same cell using \thermo\ and stops.
...
input coordinates and Bravais lattices vector and will run the job, but will 
not be able to exploit the symmetry so this option is not recommended 
except when you are deading with supercells.
