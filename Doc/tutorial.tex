...
For this case, see below the calculation of the elastic constants 
as a function of temperature. This calculation gives also the bulk 
...
Presently the main approximation is that the atomic coordinates are
relaxed only at $T=0$ K minimizing the energy and the free energy is 
