...
The CVS version of \texttt{thermo\_pw} works with the 5.3.0 version of \qe, 
...
or if the combination \texttt{thermo\_pw (CVS)} + \texttt{QE (5.3.0)} is not 
working. 
...
with the electronic exitation energy, free energy, entropy,
