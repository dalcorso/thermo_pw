...
\subsection{\color{web-blue}{what='scf'}}
...
\subsection{\color{web-blue}{what='scf}\_{ke'}}
...
\subsection{\color{web-blue}{what='scf}\_{nk'}}
With this option the code makes several self-consistent calculations, 
...
\subsection{\color{web-blue}{what='scf}\_{bands'}}
...
\subsection{\color{web-blue}{what='scf}\_{2d}\_{bands'}}
With this option the code makes a self-consistent calculation followed
...
\subsection{\color{web-blue}{what='scf}\_{dos'}}
With this option the code makes a self-consistent calculation followed
...
\subsection{\color{web-blue}{what='plot}\_{bz'}}
...
\subsection{\color{web-blue}{what='scf}\_{ph'}}
With this option the code makes a self-consistent calculation followed
...
\subsection{\color{web-blue}{what='scf}\_{disp'}}
...
\subsection{\color{web-blue}{what='scf}\_{elastic}\_{constants'}}
...
%
\subsection{\color{web-blue}{what='mur}\_{lc'}}
...
\subsection{\color{web-blue}{what='mur}\_{lc}\_{bands'}}
...
\subsection{\color{web-blue}{what='mur}\_{lc}\_{dos'}}
...
\subsection{\color{web-blue}{what='mur}\_{lc}\_{ph'}}
...
\subsection{\color{web-blue}{what='mur}\_{lc}\_{disp'}}
...
\subsection{\color{web-blue}{what='mur}\_{lc}\_{elastic}\_{constants'}}
...
\subsection{\color{web-blue}{what='mur}\_{lc}\_{t'}}
...
\subsection{\color{web-blue}{what='elastic}\_{constants}\_{t'}}
