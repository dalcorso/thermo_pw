...
\item Plot of the Brillouin zone and of high symmetry paths.
...
flasy       : initial part of the name of the files where gnuplot scripts 
              are written, and of the name of the pdf file.
              Default: character(len=*) 'asy.tmp'
asymptote_command  : the command used to produce the pdf file of the BZ.
              Default: character(len=*) 'asy -config="" -f pdf -noprc flasy.asy'
\end{verbatim}
