...
instance with the command \texttt{tar -xzvf thermo\_pw.0.6.0.tar.gz}, you
...
Two additional variables can be specified in the \thermo\ input to control
...
\end{verbatim}
Number of tasks for frequency calculations: nfs, the number of frequencies.
