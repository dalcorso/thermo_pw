...
\item
Crystallographic parameters, thermal expansion tensor, and volume thermal
expansion as a function of temperature (\texttt{lmurn=.FALSE.}). The number of
...
of which their are the derivative.
