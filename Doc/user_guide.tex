...
\title{
  ...
  \vspace{3truecm}
  % title
  \Huge \color{blue} {\sc Thermo\_pw} User's Guide \\
  (v.\version)
}
...
\subsection{\color{web-blue}{\sc what='scf\_ke'}}
...
\subsection{\color{web-blue}{\sc what='scf\_nk'}}
With this option the code makes several self-consistent calculations, 
...
\subsection{\color{web-blue}{\sc what='scf\_bands'}}
...
\subsection{\color{web-blue}{\sc what='scf\_2d\_bands'}}
...
\subsection{\color{web-blue}{\sc what='scf\_dos'}}
With this option the code makes a self-consistent calculation followed
...
\subsection{\color{web-blue}{\sc what='plot\_bz'}}
...
\subsection{\color{web-blue}{\sc what='scf\_ph'}}
With this option the code makes a self-consistent calculation followed
...
\subsection{\color{web-blue}{\sc what='scf\_disp'}}
...
\subsection{\color{web-blue}{\sc what='scf\_elastic\_constants'}}
...
%
\subsection{\color{web-blue}{\sc what='mur\_lc'}}
...
\subsection{\color{web-blue}{\sc what='mur\_lc\_bands'}}
...
\subsection{\color{web-blue}{\sc what='mur\_lc\_dos'}}
...
\subsection{\color{web-blue}{\sc what='mur\_lc\_ph'}}
...
\subsection{\color{web-blue}{\sc what='mur\_lc\_disp'}}
...
\subsection{\color{web-blue}{\sc what='mur\_lc\_elastic\_constants'}}
...
\subsection{\color{web-blue}{\sc what='mur\_lc\_t'}}
...
\subsection{\color{web-blue}{\sc what='elastic\_constants\_t'}}
