...
\texttt{elastic\_algorithm='energy'}, the code computes the phonon 
dispersions and computes the elastic constants at each temperature 
...
With this option the pressure control is not active. \\
Number of tasks for this option: \texttt{ngeo\_strain} times the number of
...
\texttt{what='mur\_lc'}, and writes them on separate files, one for
...
implemented with this option and the pressure control is not active. 
The option is presently limited to cubic crystals and it is 
very experimental.
