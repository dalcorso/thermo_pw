...
calculated as a function of temperature by a direct integration over 
the Brillouin zone.
...
you need to send several time the \thermo\ run. 
...
group) representations are used, yellow or pink means that projective
representations are used. A yellow background indicates that no switch 
