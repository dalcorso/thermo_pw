...
It assumes some familiarity with the \qe\ package. 
...
parameters. Murnaghan fit. Enthalpy as a function of pressure. Crystal
...
nvol       : number of volumes in Murnaghan plot.
             Default: integer 51
press_min  : minimum pressure for the plot of the enthalpy as a function
             of pressure. In kbar units.
             Default: real -50 kbar
press_max  : maximum pressure for the plot of the enthalpy as a function
             of pressure. In kbar units.
             Default: real 100 kbar
npress     : number of pressures between press_min and press_max.
             Default: integer 150
...
poly_degree_grun : degree of the polynomial used to interpolate 
                ...
                otherwise it is 2).
                Default: 4
temp_nstep    : every temp_nstep temperatures the murnaghan energy(omega)
                and the pressure(omega) curves are written on file.
...
geometry to a set of energy files inside the restart directory. 
