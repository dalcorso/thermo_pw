...
The version of \texttt{thermo\_pw} and that of \qe\ must be carefully matched. 
The following table illustrates the compatibility between \qe\ and 
\texttt{thermo\_pw}. There is no \texttt{thermo\_pw} package
for the versions of \qe\ not listed here.
\begin{center}
\begin{table}
\begin{tabular}{ll}
\hline
...
\end{table}
\end{center}
The \texttt{CVS} version of \texttt{thermo\_pw} can be downloaded as 
described at
the web page: \texttt{http://www.qe-} \texttt{forge.org/gf/project/thermo\_pw/scmcvs/?action=AccessInfo}.
The CVS version of \texttt{thermo\_pw} works with the \texttt{SVN} version 
of \qe.
