...
\subsection{\color{web-blue}\texttt{what='elastic\_constants\_qha'}}
...
with respect to strain. Note however that the plotted elastic constants
are those obtained from the stress-strain relationship. Presently this 
option can be used only for cubic solids. 
