...
of temperature for cubic solids, $a$ and $c/a$ for tetragonal and hexagonal 
solids. For ortorhombic solids it shows also $b/a$, while for trigonal solids
it shows $a$ and $\cos\alpha$. For monoclinic
solids it shows $a$, $b/a$, $c/a$, and $\cos\alpha$ (c-unique) or 
