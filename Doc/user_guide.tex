...
on the calculation and can be used to tune the accuracy of the calculation.
...
\texttt{control\_ph} and can be at a single {\bf q} point or on a mesh of 
{\bf q} points. 
...
geometry that corresponds to the minimum energy. The energy minimization is 
...
geometry that minimize the energy. The
