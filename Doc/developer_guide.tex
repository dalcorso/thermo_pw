...
idle.
Presently \tpw\ has two asyhnchronous runs each one followed
...
thermodynamic quatities are calculated synchronously in a loop over 
the geometries.
...
it contains gauges informations for points at zone border in nonsymmorphic
space groups.
