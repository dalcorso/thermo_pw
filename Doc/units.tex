...
\title{
  ...
  \vspace{3truecm}
  % title
  \Huge \color{blue} Units \\ (v.\version)
}
...
\end{equation}
Note also that $\bar f = {E_h \over a_B}$ so 
$\bar \sigma = {E_h \over a_B^3}$.
}
...
so that the Boltzmann constant is $\kb J / K$.
\\
...
\begin{equation}
R=k_B N_A = \kb\ {J\over K} \times \avonum = \rgas\ {J\over K}.
\end{equation}
\\

The heat necessary to increase the temperature of water from $16.5$ $^\circ$C
to $17.5$ $^\circ$C is known as (thermochemical) calorie (symbol cal) and 
is equal to $4.184$ J. This is the definition that we use in \tpw. 
There is also another definition of calorie called international calorie and
equal to $4.1868$ J, but we do not use it.
}
...
\begin{verbatim}
     ...
     Material properties (a.u. - SI):
     Int. force const.: \ifc=   1.55689310282E+03   J/m^2
     Dyn. mag. charge: \dmc=    3.50506782501E-13   A m
     ME tensor (I): \alpha=     4.57102890439E-07   s/m
     ME tensor (II): \alpha'=   3.05882401116E-10   s/m

     Material properties (c.g.s. - SI):
     Dyn. mag. charge: \dmc=    9.99999999726E-02   A m
     ME tensor (I): \alpha=     3.33564095198E-09   s/m
     ME tensor (II): \alpha'=   4.19169004390E-08   s/m
