...
!-----------------------------------------------------------------------
subroutine ef_shift_tpw (drhoscf, ldos, ldoss, dos_ef, irr, npe, flag)
  !-----------------------------------------------------------------------
...
! modules from phcom
  ...
  return
end subroutine ef_shift_tpw

!-----------------------------------------------------------------------
subroutine ef_shift_paw_tpw (drhoscf, dbecsum, ldos, ldoss, becsum1, &
                         dos_ef, irr, npe, flag)
  !-----------------------------------------------------------------------
  !    This routine takes care of the effects of a shift of Ef, due to the
  !    perturbation, that can take place in a metal at q=0
  ...
  call stop_clock ('ef_shift')
  return
end subroutine ef_shift_paw_tpw

END MODULE efermi_shift_tpw
