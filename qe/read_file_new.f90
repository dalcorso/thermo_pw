...
SUBROUTINE read_file_tpw()
  ...
  !
END SUBROUTINE read_file_tpw
!
!----------------------------------------------------------------------------
SUBROUTINE read_xml_file_tpw ( )
  !----------------------------------------------------------------------------
  !
  ...
  !
  !
  CALL pw_readschema_file_tpw ( ierr, output_obj, parinfo_obj, geninfo_obj)
  ...
  CONTAINS
    ...
    !
  END SUBROUTINE read_xml_file_tpw

SUBROUTINE pw_readschema_file_tpw ( ierr, output_obj, parinfo_obj, geninfo_obj)
  ...
  CALL bcast_general_info_type(geninfo_obj, ionode_id, intra_image_comm)
  CALL bcast_parallel_info_type(parinfo_obj, ionode_id, intra_image_comm)

RETURN
END SUBROUTINE pw_readschema_file_tpw
