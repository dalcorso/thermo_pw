...
subroutine stress_tpw ( sigma )
  ...
  !
  call stres_gradcorr_tpw ( rho%of_r, rho%of_g, rho_core, rhog_core, &
       rho%kin_r, nspin, dfftp, g, alat, omega, sigmaxc)
  !
