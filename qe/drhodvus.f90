...
subroutine drhodvus_tpw (irr, imode0, dvscfin, npe)
  !-----------------------------------------------------------------------
  !
...
!         call tra_write_matrix_tpw('drhodvus dyn1',dyn1,u,nat)
!         call tra_write_matrix_tpw('drhodvus dyn',dyn,u,nat)
  !       call stop_ph(.true.)
  dyn (:,:) = dyn (:,:) + dyn1 (:,:)
  dyn_rec(:,:) = dyn1(:,:)
