...
Important Note: The Git version can only be used with <code>QE</code> version <code>7.6</code>. Be aware that the Git version may not always function correctly, and its use is generally not recommended.
