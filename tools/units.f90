...
WRITE(stdout,'(5x,"Planck constant: ",17x,es20.8,"      J.s")') hplanck
WRITE(stdout,'(5x,"Planck constant / 2 pi:",16x,es20.13," J.s")') hbarf
WRITE(stdout,'(5x,"Speed of light: ",18x,es20.8,"      m/s")') cspeed
WRITE(stdout,'(5x,"Electron charge: ",18x,es20.9,"     C")') e

WRITE(stdout,'(/,5x,"Approximate quantities determined by experiment:")') 
WRITE(stdout,'(5x,"Rydberg constant: ",21x,es20.13," 1/m")') rydberg
WRITE(stdout,'(5x,"Fine structure constant: ",12x,es19.10)') alphaf
WRITE(stdout,'(5x,"Atomic mass unit: ",19x,es20.11,"   kg")') amu
...
WRITE(stdout,'(5x,"Electron mass: ",21x,es20.10,"    kg")') me
WRITE(stdout,'(5x,"mu0: ",32x,es20.11,"   N/A^2")') mu0
WRITE(stdout,'(5x,"epsilon0: ",26x,es20.10,"    C^2/N m^2")') epsilon0
WRITE(stdout,'(5x,"E_hatree: ",29x,es20.13," J")') baru
WRITE(stdout,'(5x,"Bohr radius: ",24x,es20.11,"   m")') abohr
WRITE(stdout,'(5x,"Bohr magneton: ",21x,es20.10,"    J/T")') bohrmag
...
WRITE(stdout,'(5x,"Acceleration: \a=",19x,es20.10,"    m/s^2")') bara
WRITE(stdout,'(5x,"Momentum: \p=",24x,es20.11,"   kg m/s")') barp
WRITE(stdout,'(5x,"Angular momentum: \L=",18x,es20.13," kg m^2/s")') baram
WRITE(stdout,'(5x,"Force: \f=",26x,es20.10,"    N")') barf
WRITE(stdout,'(5x,"Energy: \U=",28x,es20.13," J")') baru
WRITE(stdout,'(5x,"Power: \W=",29x,es20.13," W")') barw
WRITE(stdout,'(5x,"Pressure: \pr=",22x,es20.10,"    Pa")') barpr
WRITE(stdout,'(5x,"Current: \I=",26x,es20.12,"  A")') bari
WRITE(stdout,'(5x,"Charge: \C=",24x,es20.9,"     C")') barc
WRITE(stdout,'(5x,"Charge density: \rho=",16x,es20.11,"   C/m^3")') barrho
WRITE(stdout,'(5x,"Current density: \J=",17x,es20.11,"   A/m^2")') barcur
WRITE(stdout,'(5x,"Electric field: \E=",18x,es20.11,"   N/C")') bare
WRITE(stdout,'(5x,"Electric potential: \V=",16x,es20.13," V")') barphi
WRITE(stdout,'(5x,"Capacitance: \F=",22x,es20.12,"  F")') barcap
WRITE(stdout,'(5x,"Dipole moment: \dip=",16x,es20.10,"    C m")') bardip
WRITE(stdout,'(5x,"Polarization: \P=",19x,es20.10,"    C/m^2")') barpolar
WRITE(stdout,'(5x,"Electric displacement: \D=",12x,es18.10,"    C/m^2")') bard
WRITE(stdout,'(5x,"Resistance: \R=",24x,es20.13," Ohm")') barohm
WRITE(stdout,'(5x,"Magnetic induction: \B=",14x,es20.11,"   T")') barb
WRITE(stdout,'(5x,"Vector potential: \A=",16x,es20.11,"   T m")') barav
WRITE(stdout,'(5x,"Magnetic field flux: \Phi=",13x,es20.13," Wb")') barwb
WRITE(stdout,'(5x,"Inductance: \Y= ",22x,es20.12,"  H")') bary
WRITE(stdout,'(5x,"Magnetic dipole: \mu=",16x,es20.11,"   A m^2 (J/T)")') barmu
WRITE(stdout,'(5x,"Magnetization: \M=",19x,es20.11,"   A/m")') barmag
WRITE(stdout,'(5x,"Magnetic strength: \H=",14x,es20.10,"    A/m")') barh
...
WRITE(stdout,'(5x,"Speed: cm/s=",15x,es20.1,10x,"   m/s")') cmtom
WRITE(stdout,'(5x,"Acceleration: cm/s^2=",6x,es20.1,10x,"   m/s^2")') cmtom
WRITE(stdout,'(5x,"Momentum: g cm/s=",11x,es19.1,10x,"   kg m/s")') ptop
WRITE(stdout,'(5x,"Angular momentum: g cm^2/s=",11x,es9.1,10x,"   kg m^2/s")')&
                                                                ltol
WRITE(stdout,'(5x,"Force: dyne=",15x,es20.1,10x,"   N")') ftof
WRITE(stdout,'(5x,"Energy: erg=",15x,es20.1,10x,"   J")') utou
WRITE(stdout,'(5x,"Power: erg/s=",14x,es20.1,10x,"   W")') utou
WRITE(stdout,'(5x,"Pressure: Ba=",14x,es20.1,10x,"   Pa")') prtopr
WRITE(stdout,'(5x,"Current: statA=",22x,es20.11,"   A")') itoi
WRITE(stdout,'(5x,"Charge: statC=",23x,es20.11,"   C")') chtoch
WRITE(stdout,'(5x,"Charge density: statC/cm^3=",11x,es19.11,1x,&
                                                        &"  C/m^3")') rhotorho
WRITE(stdout,'(5x,"Current density: statA/cm^2=",11x,es18.11,1x,&
                                                        &"  A/m^2")') curtocur
WRITE(stdout,'(5x,"Electric field: dyne/statC=",11x,es19.11,1x,"  N/C")') &
                                                                     etoe
WRITE(stdout,'(5x,"Electric potential: statV=",12x,es19.11,1x,"  V")') &
                                                                     phitophi
WRITE(stdout,'(5x,"Capacitance: cm=",21x,es20.11,1x,"  F")') captocap
WRITE(stdout,'(5x,"Dipole moment: statC cm=",13x,es20.11,&
                                            &1x,"  C m")') diptodip
WRITE(stdout,'(5x,"Electric polarization: statC/cm^2=",3x,es20.11,&
                                            &"   C/m^2")') polartopolar
WRITE(stdout,'(5x,"Electric displacement: statC/cm^2 4 pi=",es18.11,&
                                            &"   C/m^2")') dtod
WRITE(stdout,'(5x,"Resistance: s/cm=",21x,es20.12,"  Ohm")') ohmtoohm
WRITE(stdout,'(5x,"Magnetic induction: G=",16x,es20.12,"  T")') btob
WRITE(stdout,'(5x,"Vector potential: G cm=",15x,es20.12,"  T m")') avtoav
WRITE(stdout,'(5x,"Magnetic field flux: Mx=",14x,es20.12,"  Wb")') wbtowb
WRITE(stdout,'(5x,"Inductance: statH=",19x,es20.11,2x," H")') ytoy
WRITE(stdout,'(5x,"Magnetic dipole: statC cm=",11x,es20.11,2x,&
                                            &" A m^2")') mutomu
WRITE(stdout,'(5x,"Magnetization: statC/cm^2=",11x,es20.11,2x," A/m")') &
                                                         magtomag
WRITE(stdout,'(5x,"Magnetic strength: statC/cm^2 4 pi=",2x,&
                                     &es20.11,"   A/m")') htoh
...
WRITE(stdout,'(5x,"Mass: kg=",18x,es20.1,10x,"   g")')   1.0_DP/gtokg
WRITE(stdout,'(5x,"Time: s=",32x,"1.0E+00",11x,"  s")') 
WRITE(stdout,'(5x,"Frequency: Hz=",26x,"1.0E+00",11x,"  Hz")') 
WRITE(stdout,'(5x,"Speed: m/s=",16x,es20.1,10x,"   cm/s")') 1.0_DP/cmtom
WRITE(stdout,'(5x,"Acceleration: m/s^2=",12x,es15.1,10x,"   cm/s^2")') &
                                                              1.0_DP/cmtom
WRITE(stdout,'(5x,"Momentum: kg m/s=",12x,es18.1,10x"   g cm/s")') 1.0_DP/ptop
WRITE(stdout,'(5x,"Angular momentum: kg m^2/s=",12x,es8.1,10x,"   g cm^2/s")')&
                                                                1.0_DP/ltol
WRITE(stdout,'(5x,"Force: N=",18x,es20.1,10x,"   dyne")') 1.0_DP/ftof
WRITE(stdout,'(5x,"Energy: J=",17x,es20.1,10x,"   erg")') 1.0_DP/utou
WRITE(stdout,'(5x,"Power: W=",18x,es20.1,10x,"   erg/s")') 1.0_DP/utou
WRITE(stdout,'(5x,"Pressure: Pa=",14x,es20.1,10x,"   Ba")') 1.0_DP/prtopr

WRITE(stdout,'(5x,"Current: A=",26x,es20.11,"   statA")') 1.0_DP/itoi
WRITE(stdout,'(5x,"Charge: C=",27x,es20.11,"   statC")') 1.0_DP/chtoch
WRITE(stdout,'(5x,"Charge density: C/m^3=",15x,es20.11,1x,&
                                           &"  statC/cm^3")') 1.0_DP/rhotorho
WRITE(stdout,'(5x,"Current density: A/m^2=",14x,es20.11,1x,&
                                           &"  statA/cm^2")') 1.0_DP/curtocur
WRITE(stdout,'(5x,"Electric field: N/C=",17x,es20.11,1x,"  dyne/statC")') &
                                                             1.0_DP/etoe
WRITE(stdout,'(5x,"Electric potential: V=",15x,es20.11,1x,"  statV")') &
                                                          1.0_DP/phitophi
WRITE(stdout,'(5x,"Capacitance: F=",22x,es20.11,1x,"  cm")') 1.0_DP/captocap
WRITE(stdout,'(5x,"Dipole moment: C m=",18x,es20.11,1x,"  statC cm")') 1.0_DP/diptodip
WRITE(stdout,'(5x,"Electric polarization: C/m^2=",8x,es20.11,&
                                      &"   statC/cm^2")') 1.0_DP/polartopolar
WRITE(stdout,'(5x,"Electric displacement: C/m^2=",8x,es20.11,&
                                            &"   statC/cm^2 4pi")') 1.0_DP/dtod
WRITE(stdout,'(5x,"Resistance: Ohm=",22x,es20.12,"  s/cm")') &
                                                          1.0_DP/ohmtoohm
WRITE(stdout,'(5x,"Magnetic induction: T=",16x,es20.12,&
                                            &"  G")') 1.0_DP/btob
WRITE(stdout,'(5x,"Vector potential: T m=",16x,es20.12,&
                                            &"  G cm")') 1.0_DP/avtoav
WRITE(stdout,'(5x,"Magnetic field flux: Wb=",14x,es20.12,&
                                            &"  Mx")') 1.0_DP/wbtowb
WRITE(stdout,'(5x,"Inductance: H=",23x,es20.11,1x,"  statH")') 1.0_DP/ytoy
WRITE(stdout,'(5x,"Magnetic dipole: A m^2=",14x,es20.11,1x,&
                                            &"  statC cm")') 1.0_DP/mutomu
WRITE(stdout,'(5x,"Magnetization: A/m=",18x,es20.11,1x,"  statC/cm^2")') &
                                                         1.0_DP/magtomag
WRITE(stdout,'(5x,"Magnetic strength: A/m=",&
                                &14x,es20.11,"   statC/cm^2 4pi")') 1.0_DP/htoh
...
WRITE(stdout,'(5x,"Acceleration:",23x,es20.10,"    cm/s^2")') baracgs
WRITE(stdout,'(5x,"Momentum:",28x,es20.11,"   g cm/s")') barpcgs
WRITE(stdout,'(5x,"Angular momentum:",22x,es20.13," g cm^2/s")') baramcgs
WRITE(stdout,'(5x,"Force:",30x,es20.10,"    dyne")') barfcgs
WRITE(stdout,'(5x,"Energy:",32x,es20.13," erg")') barucgs
WRITE(stdout,'(5x,"Power:",33x,es20.13," erg/s")') barwcgs
WRITE(stdout,'(5x,"Pressure:",27x,es20.10,"    Ba")') barprcgs
WRITE(stdout,'(5x,"Current:",29x,es20.11,"   statA")') baricgs
WRITE(stdout,'(5x,"Charge:",30x,es20.11,"   statC")') barccgs
WRITE(stdout,'(5x,"Charge density:",21x,es20.10,3x," statC/cm^3")') barrhocgs
WRITE(stdout,'(5x,"Current density:",20x,es20.10,3x," statA/cm^2")') barcurcgs
WRITE(stdout,'(5x,"Electric field:",22x,es20.11,2x," dyne/statC")') barecgs
WRITE(stdout,'(5x,"Electric potential:",18x,es20.11,2x," statV")') barphicgs
WRITE(stdout,'(5x,"Capacitance:",25x,es20.11,2x," cm")') barcapcgs
WRITE(stdout,'(5x,"Dipole moment:",23x,es20.11,2x," statC cm")') bardipcgs
WRITE(stdout,'(5x,"Polarization:",24x,es20.11,2x," statC/cm^2")') barpolarcgs
WRITE(stdout,'(5x,"Electric displacement:",15x,es20.11,&
                                           &"   statC/cm^2 4pi")') bardcgs
WRITE(stdout,'(5x,"Resistance:",26x,es20.11,2x," s/cm")') barohmcgs
WRITE(stdout,'(5x,"Magnetic induction:",18x,es20.11,2x," G")') barbcgs
WRITE(stdout,'(5x,"Vector potential:",20x,es20.11,2x," G cm")') baravcgs
WRITE(stdout,'(5x,"Magnetic field flux:",17x,es20.11,2x," Mx")') barwbcgs
WRITE(stdout,'(5x,"Inductance:",26x,es20.11,"   statH")') barycgs
WRITE(stdout,'(5x,"Magnetic dipole:",21x,es20.11,"   statC cm")') barmucgs
WRITE(stdout,'(5x,"Magnetization:",23x,es20.11,&
                                           &"   statC/cm^2")') barmagcgs
WRITE(stdout,'(5x,"Magnetic strength:",19x,es20.11,"   statC/cm^2 4pi ")') &
                                                               barhcgs
...
WRITE(stdout,'(5x,"Length: \l_R=",24x,es20.11,"   m")') barl
WRITE(stdout,'(5x,"Mass: \m_R=",26x,es20.11,"   kg")') barmry
WRITE(stdout,'(5x,"Time: \t_R=",28x,es20.13," s")') bartry
WRITE(stdout,'(5x,"Frequency: \nu_R=",22x,es20.13," Hz")') barnury
WRITE(stdout,'(5x,"Speed: \v_R=",25x,es20.11,"   m/s")') barvry
WRITE(stdout,'(5x,"Acceleration: \a_R=",18x,es20.11,"   m/s^2")') barary
WRITE(stdout,'(5x,"Momentum: \p_R=",22x,es20.11,"   kg m/s")') barp
WRITE(stdout,'(5x,"Angular momentum: \L_R=",16x,es20.13," kg m^2/s")') baram
WRITE(stdout,'(5x,"Force: \f_R=",25x,es20.11,"   N")') barfry
WRITE(stdout,'(5x,"Energy: \U_R=",26x,es20.13," J")') barury
WRITE(stdout,'(5x,"Power: \W_R=",26x,es20.12,"  W")') barwry
WRITE(stdout,'(5x,"Pressure: \pr_R=",21x,es20.11,"   Pa")') barprry
WRITE(stdout,'(5x,"Current: \I_R=",25x,es20.13," A")') bariry
WRITE(stdout,'(5x,"Charge: \C_R=",26x,es20.13," C")') barcry
WRITE(stdout,'(5x,"Charge density: \rho_R=",13x,es20.10,"    C/m^3")') barrhory
WRITE(stdout,'(5x,"Current density: \J_R=",15x,es20.11,"   A/m^2")') barcurry
WRITE(stdout,'(5x,"Electric field: \E_R=",16x,es20.11,"   N/C")') barery
WRITE(stdout,'(5x,"Electric potential: \V_R=",14x,es20.13," V")') barphiry
WRITE(stdout,'(5x,"Capacitance: \F_R=",20x,es20.12,"  F")') barcap
WRITE(stdout,'(5x,"Dipole moment: \dip_R=",15x,es20.11,"   C m")') bardipry
WRITE(stdout,'(5x,"Polarization: \P_R=",17x,es20.10,"    C/m^2")') barpolarry
WRITE(stdout,'(5x,"Electric displacement: \D_R=",11x,es18.11,"   C/m^2")') &
                                                                  bardry
WRITE(stdout,'(5x,"Resistance: \R_R=",22x,es20.13," Ohm")') barohmry
WRITE(stdout,'(5x,"Magnetic induction: \B_R=",11x,es20.10,"    T")') barbry
WRITE(stdout,'(5x,"Vector potential: \A_R=",14x,es20.11,"   T m")') baravry
WRITE(stdout,'(5x,"Magnetic field flux: \Phi_R=",11x,es20.13," Wb")') barwbry
WRITE(stdout,'(5x,"Inductance: \Y_R= ",21x,es20.13," H")') baryry
WRITE(stdout,'(5x,"Magnetic dipole: \mu_R=",13x,es20.10,"    A m^2 (J/T)")') &
                                                                    barmury
WRITE(stdout,'(5x,"Magnetization: \M_R=",17x,es20.11,"   A/m")') barmagry
WRITE(stdout,'(5x,"Magnetic field: \H_R=",16x,es20.11,"   A/m")') barhry
...
WRITE(stdout,'(5x,"rydberg = ",7x,es20.2," 1/m",4x,es18.2)') rydbergerr, rydbergerr/rydberg
WRITE(stdout,'(5x,"alpha = ",9x,es20.2,2x,4x,es20.2)') alphaerr, alphaerr/alphaf
WRITE(stdout,'(5x,"amu = ",11x,es20.2,2x,4x,es20.2)') amuerr, amuerr/amu
WRITE(stdout,*)
...
WRITE(stdout,'(5x,"me = ",12x,es20.2," kg",4x,es19.2)') meerr, meerr/me
WRITE(stdout,'(5x,"abohr = ",9x,es20.2," m",4x,es20.2)') &
                                                    abohrerr, abohrerr/abohr
WRITE(stdout,'(5x,"mu0 = ",11x,es20.2," N/A^2",4x,es16.2)') mu0err, mu0err/mu0
WRITE(stdout,'(5x,"epsilon0 = ",6x,es20.2," C^2/Nm^2",4x,es13.2)') &
                                       epsilon0err, epsilon0err/epsilon0
WRITE(stdout,'(5x,"hartree = ",7x,es20.2," J", 4x,es20.2)') hartreeerr, &
                                                    hartreeerr/baru
WRITE(stdout,'(5x,"bohr mag = ",6x,es20.2," J/T", 4x,es18.2)') bohrmagerr, &
                                                    bohrmagerr/bohrmag
WRITE(stdout,*)
...
WRITE(stdout,'(5x,"\nu = ",11x,es20.2," s", 4x,es20.2)') barnuerr, &
                                                        barnuerr/barnu
WRITE(stdout,'(5x,"\v = ",12x,es20.2," m/s", 4x,es18.2)') barverr, barverr/barv
WRITE(stdout,'(5x,"\a = ",12x,es20.2," m/s^2", 4x,es16.2)') baraerr, &
                                                        baraerr/bara
WRITE(stdout,'(5x,"\p = ",12x,es20.2," kg m/s", 4x,es15.2)') barperr, &
                                                        barperr/barp
WRITE(stdout,'(5x,"\L = ",12x,es20.2," kg m^2/s",es17.2)') zero, zero
WRITE(stdout,'(5x,"\f = ",12x,es20.2," N", 4x,es20.2)') barferr, barferr/barf
WRITE(stdout,'(5x,"\U = ",12x,es20.2," J", 4x,es20.2)') hartreeerr, &
                                                        hartreeerr/baru
WRITE(stdout,'(5x,"\W = ",12x,es20.2," W", 4x,es20.2)') barwerr, barwerr/barw
WRITE(stdout,'(5x,"\pr = ",11x,es20.2," Pa", 4x,es19.2)') barprerr, &
                                                        barprerr/barpr
WRITE(stdout,'(5x,"\I = ",12x,es20.2," A", 4x,es20.2)') barierr, barierr/bari
WRITE(stdout,'(5x,"\C = ",12x,es20.2," C", 4x,es20.2)') zero, zero
WRITE(stdout,'(5x,"\rho = ",10x,es20.2," C/m^3", 4x,es16.2)') barrhoerr, &
                                                        barrhoerr/barrho
WRITE(stdout,'(5x,"\J = ",13x,es19.2," A/m^2", 4x,es16.2)') barcurerr, &
                                                        barcurerr/barcur
WRITE(stdout,'(5x,"\E = ",12x,es20.2," V/m", 4x,es18.2)') bareerr, &
                                                        bareerr/bare
WRITE(stdout,'(5x,"\V = ",12x,es20.2," V", 4x,es20.2)') barphierr, &
                                                        barphierr/barphi
WRITE(stdout,'(5x,"\F = ",12x,es20.2," F", 4x,es20.2)') barcaperr, &
                                                        barcaperr/barcap
WRITE(stdout,'(5x,"\dip = ",8x,es22.2," C m", 4x,es18.2)') bardiperr, &
                                                        bardiperr/bardip
WRITE(stdout,'(5x,"\P = ",12x,es20.2," C/m^2", 4x,es16.2)') barpolarerr, &
                                                        barpolarerr/barpolar
WRITE(stdout,'(5x,"\D = ",12x,es20.2," C/m^2",4x, es16.2)') barderr, &
                                                        barderr/bard
WRITE(stdout,'(5x,"\R = ",12x,es20.2," Ohm", 2x,es20.2)') zero, zero
WRITE(stdout,'(5x,"\B = ",12x,es20.2," T", 4x,es20.2)') barberr, barberr/barb
WRITE(stdout,'(5x,"\A = ",12x,es20.2," T m", 2x,es20.2)') baraverr, &
                                                          baraverr/barav
WRITE(stdout,'(5x,"\phi = ",10x,es20.2," Wb", 3x,es20.2)') zero, zero
WRITE(stdout,'(5x,"\Y = ",12x,es20.2," H", 4x,es20.2)') baryerr, baryerr/bary
WRITE(stdout,'(5x,"\mu = ",11x,es20.2," J/T", 4x,es18.2)') barmuerr, &
                                                        barmuerr/barmu
WRITE(stdout,'(5x,"\M = ",12x,es20.2," A/m", 4x,es18.2)') barmagerr, &
                                                        barmagerr/barmag
WRITE(stdout,'(5x,"\H = ",12x,es20.2," A/m", 4x,es18.2)') barherr, &
                                                        barherr/barh
WRITE(stdout,*)
cspeedauerr=barverr/barv * cspeedau
amuauerr=(amuerr/amu+meerr/me) * amuau
WRITE(stdout,'(5x,"cspeed = ",8x,es20.2," \v",5x,es18.2)') cspeedauerr, &
                                              cspeedauerr/cspeedau 
WRITE(stdout,'(5x,"amu = ",11x,es20.2," \m",5x,es18.2)') amuauerr, &
                                              amuauerr/amuau 
...
WRITE(stdout,'(5x,"Current = ",7x,es20.2," A", 4x,es20.2)') itoierr, &
                                                           itoierr/itoi
WRITE(stdout,'(5x,"Charge = ",8x,es20.2," C", 4x,es20.2)') itoierr, &
                                                           itoierr/itoi
WRITE(stdout,'(5x,"Charge density = ",es20.2," C/m^3", 4x,es16.2)') &
                                      rhotorhoerr, rhotorhoerr/rhotorho
WRITE(stdout,'(5x,"Current density = ",es19.2," A/m^2", 4x,es16.2)') &
                                      curtocurerr, curtocurerr/curtocur
WRITE(stdout,'(5x,"Electric field = ",es20.2," V/m", 4x,es18.2)') etoeerr, &
                                      etoeerr/etoe
WRITE(stdout,'(5x,"Electric potential = ",es16.2," V", 4x,es20.2)') &
                                      phitophierr, phitophierr/phitophi
WRITE(stdout,'(5x,"Capacitance = ",3x,es20.2," F", 4x,es20.2)') captocaperr, &
                                      captocaperr/captocap
WRITE(stdout,'(5x,"Dipole moment = ",1x,es20.2," C m", 4x,es18.2)') &
                                      diptodiperr, diptodiperr/diptodip
WRITE(stdout,'(5x,"Electric Polarization = ",es13.2," C/m^2", 4x,es16.2)') &
                            polartopolarerr, polartopolarerr/polartopolar
WRITE(stdout,'(5x,"Electric Displacement = ",es13.2," C/m^2",4x, es16.2)') &
                                                 dtoderr, dtoderr/dtod
WRITE(stdout,'(5x,"Resistance = ",4x,es20.2," Ohm", 4x,es18.2)') ohmtoohmerr, &
                                              ohmtoohmerr/ohmtoohm
WRITE(stdout,'(5x,"Magnetic induction = ",es16.2," T", 4x,es20.2)') &
                                              btoberr, btoberr/btob
WRITE(stdout,'(5x,"Vector potential = ",es18.2," T m",2x,es20.2)') &
                                              avtoaverr, avtoaverr/avtoav
WRITE(stdout,'(5x,"Magnetic field flux = ",es15.2," Wb", 4x,es19.2)') &
                                             wbtowberr, wbtowberr/wbtowb
WRITE(stdout,'(5x,"Inductance = ",4x,es20.2," H", 4x,es20.2)') ytoyerr, &
                                               ytoyerr/ytoy
WRITE(stdout,'(5x,"Magnetic dipole = ",es19.2," J/T", 4x,es18.2)') &
                                         mutomuerr, mutomuerr/mutomu
WRITE(stdout,'(5x,"Magnetization = ",1x,es20.2," A/m", 4x,es18.2)') &
                                           magtomagerr, magtomagerr/magtomag
WRITE(stdout,'(5x,"Magnetic strength = ",es17.2," A/m", 4x,es18.2)') &
...
WRITE(stdout,'(5x,"Current = ",7x,es20.2," statA", 4x,es16.2)')  &
                                   baricgserr, baricgserr/baricgs
WRITE(stdout,'(5x,"Charge = ",8x,es20.2," statC", 4x,es16.2)') &
                                   barccgserr, barccgserr/barccgs
WRITE(stdout,'(5x,"Charge density = ",1x,es19.2," statC/cm^3", 4x,es11.2)') &
                                   barrhocgserr, barrhocgserr/barrhocgs
WRITE(stdout,'(5x,"Current density = ",es19.2," statA/cm^2", 4x,es11.2)') &
                                   barcurcgserr, barcurcgserr/barcurcgs
WRITE(stdout,'(5x,"Electric field = ",es20.2," statV/cm",4x,es13.2)') &
                                   barecgserr, barecgserr/barecgs
WRITE(stdout,'(5x,"Electric potential = ",es16.2," statV", 4x,es16.2)') &
                                   barphicgserr, barphicgserr/barphicgs
WRITE(stdout,'(5x,"Capacitance = ",4x,es19.2," cm", 4x,es19.2)') &
                                   barcapcgserr, barcapcgserr/barcapcgs
WRITE(stdout,'(5x,"Dipole moment = ",1x,es20.2," statC cm", 4x,es13.2)') &
                                   bardipcgserr, bardipcgserr/bardipcgs
WRITE(stdout,'(5x,"Electric Polarization = ",es13.2," statC/cm^2", &
                      &4x,es11.2)') barpolarcgserr, barpolarcgserr/barpolarcgs
WRITE(stdout,'(5x,"Electric displacement = ",es13.2," statC/cm^2 4pi", &
                      &es11.2)') bardcgserr, bardcgserr/bardcgs
WRITE(stdout,'(5x,"Resistance = ",5x,es19.2," s/cm",4x,es17.2)') &
                                 barohmcgserr, barohmcgserr/barohmcgs
WRITE(stdout,'(5x,"Magnetic induction = ",es16.2," G",4x,es20.2)') &
                                 barbcgserr, barbcgserr/barbcgs
WRITE(stdout,'(5x,"Vector potential = ",es18.2," G cm",1x,es20.2)') &
                                 baravcgserr, baravcgserr/baravcgs
WRITE(stdout,'(5x,"Magnetic field flux = ",es15.2," Mx",3x,es20.2)') &
                                 barwbcgserr, barwbcgserr/barwbcgs
WRITE(stdout,'(5x,"Inductance = ",4x,es20.2," statH",es20.2)') &
                                 barycgserr, barycgserr/barycgs
WRITE(stdout,'(5x,"Magnetic dipole = ",es19.2," statC cm",4x,es13.2)') &
                                 barmucgserr, barmucgserr/barmucgs
WRITE(stdout,'(5x,"Magnetization = ",1x,es20.2," statC/cm^2",es15.2)') &
...
WRITE(stdout,'(5x,"\l_R = ",10x,es20.2," m", 4x,es20.2)') abohrerr, &
                                                          abohrerr/barl
WRITE(stdout,'(5x,"\m_R = ",10x,es20.2," kg", 3x,es20.2)') barmryerr, &
                                                          barmryerr/barmry
WRITE(stdout,'(5x,"\t_R = ",10x,es20.2," s", 4x,es20.2)') bartryerr, &
                                                          bartryerr/bart
WRITE(stdout,'(5x,"\nu_R = ",9x,es20.2," s", 4x,es20.2)') barnuryerr, &
                                                          barnuryerr/barnury
WRITE(stdout,'(5x,"\v_R = ",10x,es20.2," m/s", 4x,es18.2)') barvryerr, &
                                                          barvryerr/barvry
WRITE(stdout,'(5x,"\a_R = ",10x,es20.2," m/s^2", 4x,es16.2)') bararyerr, &
                                                          bararyerr/barary
WRITE(stdout,'(5x,"\p_R = ",10x,es20.2," kg m/s", 4x,es15.2)') barperr, &
                                                          barperr/barp
WRITE(stdout,'(5x,"\L_R = ",10x,es20.2," kg m^2/s",es17.2)') zero, zero
WRITE(stdout,'(5x,"\f_R = ",10x,es20.2," N", 4x,es20.2)') barfryerr, &
                                                          barfryerr/barfry
WRITE(stdout,'(5x,"\U_R = ",10x,es20.2," J", 4x,es20.2)') baruryerr, &
                                                          baruryerr/barury
WRITE(stdout,'(5x,"\W_R = ",10x,es20.2," W", 4x,es20.2)') barwryerr, &
                                                          barwryerr/barwry
WRITE(stdout,'(5x,"\pr_R = ",9x,es20.2," Pa", 4x,es19.2)') barprryerr, &
                                                          barprryerr/barprry
WRITE(stdout,'(5x,"\I_R = ",10x,es20.2," A", 4x,es20.2)') bariryerr, &
                                                          bariryerr/bariry
WRITE(stdout,'(5x,"\C_R = ",10x,es20.2," C", 4x,es20.2)') zero, zero
WRITE(stdout,'(5x,"\rho_R = ",8x,es20.2," C/m^3", 4x,es16.2)') barrhoryerr, &
                                                          barrhoryerr/barrhory
WRITE(stdout,'(5x,"\J_R = ",11x,es19.2," A/m^2", 4x,es16.2)') barcurryerr, &
                                                          barcurryerr/barcurry
WRITE(stdout,'(5x,"\E_R = ",10x,es20.2," V/m", 4x,es18.2)') bareryerr, &
                                                          bareryerr/barery
WRITE(stdout,'(5x,"\V_R = ",10x,es20.2," V", 4x,es20.2)') barphiryerr, &
                                                          barphiryerr/barphiry
WRITE(stdout,'(5x,"\F_R = ",10x,es20.2," F", 4x,es20.2)') barcaperr, &
                                                        barcaperr/barcap
WRITE(stdout,'(5x,"\dip_R = ",6x,es22.2," C m", 4x,es18.2)') bardipryerr, &
                                                        bardipryerr/bardipry
WRITE(stdout,'(5x,"\P_R = ",10x,es20.2," C/m^2", 4x,es16.2)') barpolarryerr, &
                                                     barpolarryerr/barpolarry
WRITE(stdout,'(5x,"\D_R = ",10x,es20.2," C/m^2",4x, es16.2)') bardryerr, &
                                                        bardryerr/bardry
WRITE(stdout,'(5x,"\R_R = ",10x,es20.2," Ohm", 2x,es20.2)') zero, zero
WRITE(stdout,'(5x,"\B_R = ",10x,es20.2," T", 4x,es20.2)') barbryerr, &
                                                        barbryerr/barbry
WRITE(stdout,'(5x,"\A_R = ",10x,es20.2," T m", 2x,es20.2)') baravryerr, &
                                                          baravryerr/baravry
WRITE(stdout,'(5x,"\phi_R = ",8x,es20.2," Wb", 3x,es20.2)') zero, zero
WRITE(stdout,'(5x,"\Y_R = ",10x,es20.2," H", 4x,es20.2)') baryryerr, &
                                                          baryryerr/baryry
WRITE(stdout,'(5x,"\mu_R = ",9x,es20.2," J/T", 4x,es18.2)') barmuryerr, &
                                                        barmuryerr/barmury
WRITE(stdout,'(5x,"\M_R = ",10x,es20.2," A/m", 4x,es18.2)') barmagryerr, &
