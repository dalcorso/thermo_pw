...
!
   ...
   DO itemp = 2, ntemp-1
      WRITE(iu_therm, '(e12.5,e20.13,e14.6,e20.13,e14.6)') temp(itemp), &
                   vmin_t(itemp), beta_t(itemp)*1.D6, b0_t(itemp), cv_t(itemp)
   END DO
   CLOSE(iu_therm)
!
...
!
   ...
   DO itemp = 2, ntemp-1
      WRITE(iu_therm, '(e12.5,e20.13,e14.6,e20.13,e14.6)') temp(itemp), &
                   vminf_t(itemp), betaf_t(itemp)*1.D6, b0f_t(itemp), &
                   cvf_t(itemp)
   END DO
   CLOSE(iu_therm)
!
...
!
   ...
   DO itemp = 1, ntemp
      WRITE(iu_therm, '(e13.6,4e16.8)') temp(itemp), &
                                  ...
                                  betab(itemp)*1.D6*ry_kbar*vminf_t(1)/&
                                  vminf_t(itemp)/b0f_t(1), &
                                  cvf_t(itemp)
   END DO
   CLOSE(iu_therm)
END IF
