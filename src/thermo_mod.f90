...
!
  ...
  REAL(DP), ALLOCATABLE :: vminf_t(:)  ! the minimum volume at each T
  REAL(DP), ALLOCATABLE :: b0f_t(:)    ! the bulk modulus at each T
  REAL(DP), ALLOCATABLE :: b01f_t(:)   ! pressure derivative of b0 at each T
  REAL(DP), ALLOCATABLE :: b02f_t(:)   ! second pressure derivative of b0
                                       ! at each T
