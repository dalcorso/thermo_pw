...
! (added the symmetry analysis of the modes at zone border for space
!  groups that contains nonsymmorphic operations)
...
SUBROUTINE dynmatrix_tpw(iq_)
  ...
  USE control_ph,    ONLY : epsil, zue, search_sym, ldisp, &
                            done_zue, ldiag, done_epsil, done_zeu, xmldyn, &
                            current_iq, qplot
  USE control_lr,    ONLY : lgamma_gamma, where_rec, rec_code
