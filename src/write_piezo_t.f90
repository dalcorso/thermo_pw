...
!
IF (ltherm_dos) THEN
   CALL interpolate_piezo_tensor(celldm_t, nvar, ibrav_save, pt_p1, &
...
IF (ltherm_freq) THEN
   CALL interpolate_piezo_tensor(celldmf_t, nvar, ibrav_save, &
...
!
CALL interpolate_el_cons_p(celldm_p, nvar, ibrav_save, ec_p1, ec_p2, ec_p3, &
...
IF (ltherm_dos) THEN
   DO ipressp=1, npress_plot
      ...
      CALL interpolate_piezo_tensor(celldm_pt(:,:,ipressp), nvar, ibrav_save, &
...
IF (ltherm_dos) THEN
   DO itempp=1, ntemp_plot
      ...
      CALL interpolate_piezo_tensor_p(celldm_ptt(:,:,itempp), nvar, &
           ibrav_save, pt_p1, pt_p2, pt_p3, pt_p4, poly_degree_elc, &
...
IF (ltherm_freq) THEN
   DO itempp=1, ntemp_plot
      itemp=itemp_plot(itempp)
      CALL interpolate_piezo_tensor_p(celldmf_ptt(:,:,itempp), nvar, &
           ibrav_save, pt_p1, pt_p2, pt_p3, pt_p4, poly_degree_elc,  &
