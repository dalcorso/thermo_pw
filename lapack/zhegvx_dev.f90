...
!
      ...
      CALL ZHEEVX_XG( JOBZ, RANGE, UPLO, N, A, LDA, VL, VU, IL, IU, ABSTOL,   & 
...
!
            ...
            END IF
!
!      CALL ZTRSM_XG( 'Left', UPLO, TRANS, 'Non-unit', N, M, CONE, B,   & 
      CALL ZTRSM_XG( 'L', UPLO, TRANS, 'N', N, M, CONE, B,   & 
                        LDB, Z, LDZ )
!
...
!
            ...
            END IF
!
!      CALL ZTRMM_XG( 'Left', UPLO, TRANS, 'Non-unit', N, M, CONE, B,   & 
      CALL ZTRMM_XG( 'L', UPLO, TRANS, 'N', N, M, CONE, B,   & 
                        LDB, Z, LDZ )
         END IF
      END IF
!
