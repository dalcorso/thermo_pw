...
#include<ieeeck_interf.f90>
#include<iparmq_interf.f90>
!
...
!     ..
!     .. External Functions ..
!      INTEGER            IEEECK_XG, IPARMQ_XG, IPARAM2STAGE_XG
!      EXTERNAL           IEEECK_XG, IPARMQ_XG, IPARAM2STAGE_XG
!     ..
!     .. Executable Statements ..

!#if defined(__CUDA)
!      ATTRIBUTES(VALUE) ::  ISPEC, NAME_, OPTS_, N1, N2, N3, N4
!#endif
#if defined(__CUDA)
...
!!!!!!!!!!!!!!!!!!!!!!!!
      IF (NAME_ == 'A') THEN 
          NAME = 'ZHEGST' 
      ELSE IF (NAME_ == 'B') THEN 
          NAME = 'ZHETRD' 
      ELSE IF (NAME_ == 'C') THEN
          NAME = 'ZUNMTR'
      ELSE IF (NAME_ == 'D') THEN
          NAME = 'ZPOTRF'
      ELSE IF (NAME_ == 'E') THEN
          NAME = 'ZUNGQL'
      ELSE IF (NAME_ == 'F') THEN
          NAME = 'ZUNGQR'
      ELSE IF (NAME_ == 'G') THEN
          NAME = 'ZUNMQR'
      ELSE IF (NAME_ == 'H') THEN
          NAME = 'ZUNMQL'
...
!
      ILAENV_XG = INT( REAL( MIN( N1, N2 ) )*1.6E0 )
      RETURN
!
  110 CONTINUE
!
...
!     ILAENV_XG = 0
      ILAENV_XG = 1
      IF( ILAENV_XG.EQ.1 ) THEN
         ILAENV_XG = IEEECK_XG( 1, 0.0, 1.0 )
      END IF
      RETURN
!
  150 CONTINUE
...
!
      ILAENV_XG = IPARMQ_XG( ISPEC, NAME, OPTS, N1, N2, N3, N4 )
      RETURN
!
!     End of ILAENV_XG
!
