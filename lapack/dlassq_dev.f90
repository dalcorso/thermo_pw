...
!
!   if( LA_ISNAN_XG(scl) .or. LA_ISNAN_XG(sumsq) ) return
   if( DISNA1_XG(scl) .or. DISNA1_XG(sumsq) ) return
...
!
!      if (amed > zero .or. LA_ISNAN_XG(amed)) then
      if (amed > zero .or. DISNA1_XG(amed)) then
