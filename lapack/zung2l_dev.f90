...
!      EXTERNAL           XERBLA_XG, ZLARF_XG, ZSCAL_XG
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC          MAX
!     ..
...
!
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         ! CALL XERBLA_XG( 'ZUNG2L', -INFO )
         CALL XERBLA_XG( 'W', -INFO )
         RETURN
      END IF
!
...
!
         A( M-N+II, II ) = ONE
!      CALL ZLARF_XG( 'Left', M-N+II, II-1, A( 1, II ), 1, TAU( I ), A,   & 
      CALL ZLARF_XG( 'L', M-N+II, II-1, A( 1, II ), 1, TAU( I ), A,   & 
                     LDA, WORK )
         CALL ZSCAL_XG( M-N+II-1, -TAU( I ), A( 1, II ), 1 )
