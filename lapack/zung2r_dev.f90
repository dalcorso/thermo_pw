...
!
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         ! CALL XERBLA_XG( 'ZUNG2R', -INFO )
         CALL XERBLA_XG( 'X', -INFO )
         RETURN
      END IF
!
...
!
         IF( I.LT.N ) THEN
            A( I, I ) = ONE
!      CALL ZLARF_XG( 'Left', M-I+1, N-I, A( I, I ), 1, TAU( I ),   & 
      CALL ZLARF_XG( 'L', M-I+1, N-I, A( I, I ), 1, TAU( I ),   & 
                        A( I, I+1 ), LDA, WORK )
         END IF
      IF( I.LT.M )   & 
            CALL ZSCAL_XG( M-I, -TAU( I ), A( I+1, I ), 1 )
         A( I, I ) = ONE - TAU( I )
!
