...
!      EXTERNAL           ZGEMV_XG, ZTRMV_XG, ZGEMM_XG
!     ..
!     .. External Functions ..
!      LOGICAL            LSAME_XG
!      EXTERNAL           LSAME_XG
...
!
!      CALL ZGEMV_XG( 'Conjugate transpose', J-I, I-1,   & 
      CALL ZGEMV_XG( 'C', J-I, I-1,   & 
        -TAU( I ), V( I+1, 1 ), LDV,   & 
...
!
      CALL ZGEMM_XG( 'N', 'C', I-1, 1, J-I, -TAU( I ),   & 
...
!
!      CALL ZTRMV_XG( 'Upper', 'No transpose', 'Non-unit', I-1, T,   & 
      CALL ZTRMV_XG( 'U', 'N', 'N', I-1, T,   & 
                           LDT, T( 1, I ), 1 )
               T( I, I ) = TAU( I )
               IF( I.GT.1 ) THEN
...
!
!      CALL ZGEMV_XG( 'Conjugate transpose', N-K+I-J, K-I,   & 
      CALL ZGEMV_XG( 'C', N-K+I-J, K-I,   & 
...
!
      CALL ZGEMM_XG( 'N', 'C', K-I, 1, N-K+I-J, -TAU( I ),   & 
...
!
!      CALL ZTRMV_XG( 'Lower', 'No transpose', 'Non-unit', K-I,   & 
      CALL ZTRMV_XG( 'L', 'N', 'N', K-I,   & 
