...
!     ..
!     .. External Functions ..
!      LOGICAL            LSAME_XG, DISNAN_XG
!      DOUBLE PRECISION   DLAMCH_XG
!      EXTERNAL           LSAME_XG, DLAMCH_XG, DISNAN_XG
!     ..
!     .. Intrinsic Functions ..
...
!
      INFO = 0
!
      IF( LSAME_XG( TYPE, 'G' ) ) THEN
         ITYPE = 0
      ELSE IF( LSAME_XG( TYPE, 'L' ) ) THEN
         ITYPE = 1
      ELSE IF( LSAME_XG( TYPE, 'U' ) ) THEN
         ITYPE = 2
      ELSE IF( LSAME_XG( TYPE, 'H' ) ) THEN
         ITYPE = 3
      ELSE IF( LSAME_XG( TYPE, 'B' ) ) THEN
         ITYPE = 4
      ELSE IF( LSAME_XG( TYPE, 'Q' ) ) THEN
         ITYPE = 5
      ELSE IF( LSAME_XG( TYPE, 'Z' ) ) THEN
         ITYPE = 6
      ELSE
         ITYPE = -1
      END IF
!
      IF( ITYPE.EQ.-1 ) THEN
         INFO = -1
      ELSE IF( CFROM.EQ.ZERO .OR. DISNAN_XG(CFROM) ) THEN
         INFO = -4
      ELSE IF( DISNAN_XG(CTO) ) THEN
         INFO = -5
      ELSE IF( M.LT.0 ) THEN
         INFO = -6
...
!
      IF( INFO.NE.0 ) THEN
         ! CALL XERBLA_XG( 'DLASCL', -INFO )
         CALL XERBLA_XG( '3', -INFO )
         RETURN
      END IF
!
