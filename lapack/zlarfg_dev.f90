...
!     ..
!     .. External Functions ..
!      DOUBLE PRECISION   DLAMCH_XG, DLAPY3_XG, DZNRM2_XG
!      COMPLEX*16         ZLADIV_XG
!      EXTERNAL           DLAMCH_XG, DLAPY3_XG, DZNRM2_XG, ZLADIV_XG
!     ..
!     .. Intrinsic Functions ..
      INTRINSIC          ABS, DBLE, DCMPLX, DIMAG, SIGN
!     ..
!     .. External Subroutines ..
!      EXTERNAL           ZDSCAL_XG, ZSCAL_XG
!     ..
...
!
      ...
      IF( N.LE.0 ) THEN
         ...
         RETURN
      END IF
      CONE=DCMPLX(ONE,0.D0)

      XNORM = DZNRM2_XG( N-1, X, INCX )
      ALPHR = DBLE( ALPHA )
      ALPHI = DIMAG( ALPHA )
!
...
!        general case
! 
         BETA = -SIGN( DLAPY3_XG( ALPHR, ALPHI, XNORM ), ALPHR )
         SAFMIN = DLAMCH_XG( 'S' ) / DLAMCH_XG( 'E' )
         RSAFMN = ONE / SAFMIN
!
         KNT = 0
...
!
   10       CONTINUE
            KNT = KNT + 1
            CALL ZDSCAL_XG( N-1, RSAFMN, X, INCX )
            BETA = BETA*RSAFMN
            ALPHI = ALPHI*RSAFMN
            ALPHR = ALPHR*RSAFMN
...
!
         ...
         ALPHA = ZLADIV_XG( DCMPLX( ONE ), ALPHA-BETA )
         CALL ZSCAL_XG( N-1, ALPHA, X, INCX )
!
