...
!      NB = MIN( NBMAX, ILAENV( 1, 'ZUNMQR', SIDE // TRANS, M, N, K,   & 
      NB = MIN( NBMAX, ILAENV_XG( 1, 'G', SIDE, M, N, K,   & 
              -1 ) )
         LWKOPT = NW*NB + TSIZE
         WORK( 1 ) = LWKOPT
      END IF
...
!
      ...
      NBMIN = MAX( 2, ILAENV_XG( 2, 'G', SIDE, M, N, K,   & 
                    -1 ) )
...
!        Use unblocked code
!
      CALL ZUNM2R_XG( SIDE, TRANS, M, N, K, A, LDA, TAU, C, LDC, WORK,   & 
                      IINFO )
      ELSE
!
!        Use blocked code
...
!
!      CALL ZLARFT_XG( 'Forward', 'Columnwise', NQ-I+1, IB, A( I, I ),   & 
      CALL ZLARFT_XG( 'F', 'C', NQ-I+1, IB, A( I, I ),   & 
...
!           Apply H or H**H
!
!      CALL ZLARFB_XG( SIDE, TRANS, 'Forward', 'Columnwise', MI, NI,   & 
      CALL ZLARFB_XG( SIDE, TRANS, 'F', 'C', MI, NI,   & 
