...
thermo_pw : bindir mods libs pw ph 
	( cd install ; $(MAKE) -f plugins_makefile thermo_pw || exit 1 )

thermo_red : bindir mods libs pw ph 
	( cd install ; $(MAKE) -f plugins_makefile thermo_red || exit 1 )
